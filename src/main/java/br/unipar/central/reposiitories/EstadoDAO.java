...
public class EstadoDAO {
    ...
    private static final String UPDATE = "UPDATE ESTADO SET nome = ?, sigla = ?, ra = ?, pais = ? WHERE ID = ?";
    ...
    public void insert(EstadoPOJO estado) throws SQLException {
        ...
        try {
             ...
             pstmt.setInt(5, estado.getPais().getId_pais());
       ...
       public void update(EstadoPOJO estado) throws SQLException {
        ...
        try {
            ...
            pstmt.setInt(4, estado.getPais().getId_pais());
            
            pstmt.setInt(5, estado.getId_estado());
